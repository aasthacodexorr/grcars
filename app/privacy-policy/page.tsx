                ...
                <main className="w-full mx-auto flex justify-center px-6 sm:px-12 py-12 lg:py-16">
                    <div className="max-w-6xl">
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="list-disc pl-5 space-y-3 text-[15px] leading-relaxed text-gray-800">
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <ol className="list-decimal pl-5 space-y-2 text-[15px] leading-relaxed text-gray-800">
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="list-disc pl-5 space-y-3 text-[15px] leading-relaxed text-gray-800 mb-4">
                                <li>

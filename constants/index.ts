  ...
  return {
    ...
    SITE_CONFIG: {
      urls: {
        ...
        vehicelInquiry:`${appConfig.site.saas_api}/api/templates/render/18`,
        ...
        onlineConsentMayur:`${appConfig.site.saas_api}/api/templates/render/13?assigneeid=17`,
        onlineConsentPranav:`${appConfig.site.saas_api}/api/templates/render/13?assigneeid=2`,
        onlineConsentDevin:`${appConfig.site.saas_api}/api/templates/render/13?assigneeid=4`,
        ...
        creditGursewak2:`${appConfig.site.saas_api}/api/templates/render/14?assigneeid=12`,
        creditGursewak:`${appConfig.site.saas_api}/api/templates/render/14?assigneeid=24`,
        creditMayur:`${appConfig.site.saas_api}/api/templates/render/14?assigneeid=17`,

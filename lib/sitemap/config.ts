...
export const SITE_PAGES = [
  ...
  '/',
  '/block-page/',
  '/used-car-financing-brampton/',
  '/car-dealerships-in-brampton/',
  '/car-loan-no/',
  '/car-loan-no-credit-brampton/',
  '/reviews/',
  '/cheap-used-cars-brampton/',
  '/finance-with-oran/',
  '/brampton-used-car-dealer/',
  '/trade-in-appraisal/',
  '/wheel-calculator/',
  '/referral/',
  '/pre-approval/',
  ...
  '/secure-guard/',
  '/online-consent-qursewak/',
  '/online-consent-mayur/',
  '/finance-with-qursewak/',
  '/credit-application-qursewak-2/',
  '/credit-application-qursewak/',

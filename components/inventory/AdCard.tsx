...
export const FinanceAdCard = () => {
  ...
  return (
    ...
    >
      ...
      <span className="mt-2 inline-block rounded-full bg-brand text-white text-[14px] px-6 py-2.5 hover:opacity-90 transition-opacity transition-colors cursor-pointer">
        Get pre-qualified
      </span>
    </CardShell>
  );

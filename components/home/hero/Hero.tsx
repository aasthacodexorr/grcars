...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-[420px] md:min-h-[550px] lg:min-h-[600px] flex flex-col justify-between px-6 md:px-12 md:py-8 lg:py-10 overflow-hidden">
